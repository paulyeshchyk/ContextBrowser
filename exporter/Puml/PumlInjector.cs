namespace ContextBrowser.exporter.Puml;
...
public static class PumlInjector
{
    ...
    public static HtmlInjection InjectActionPerDomainEmbeddedHtml(string action, string domain, string outputDirectory)
    {
        ...
        return new HtmlInjection() { EmbeddedContent = $"<render-plantuml renderMode=\"txt\">{pumlFileContent}</render-plantuml>", EmbeddedScript = pumlEmbeddedScript };
    }
