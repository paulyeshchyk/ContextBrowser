    ...
    where T : IUmlParticipant
{
    ...
    public RenderContext(UmlTransitionDto t, UmlDiagram<T> diagram, ContextTransitionDiagramBuilderOptions options, RenderContextActivationStack activationStack, OnWriteLog? log)
    {
        Transition = t;
        Diagram = diagram;
        Options = options;
