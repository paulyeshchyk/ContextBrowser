...
{
    public static RoslynCalleeSymbolDto BuildDto(this ISymbol methodSymbol)
    {
        return new RoslynCalleeSymbolDto() { Name = methodSymbol.GetFullMemberName(), ShortName = methodSymbol.GetShortestName() };
    }
}
