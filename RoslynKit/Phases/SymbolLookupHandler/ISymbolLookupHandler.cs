...
public interface ISymbolLookupHandler<TContext> where TContext : class
{
    /// <summary>
    ...
    ISymbolLookupHandler<TContext> SetNext(ISymbolLookupHandler<TContext> handler);
    ...
    TContext? Handle(InvocationSyntaxWrapper symbolDto);
}
