...
{
    public static void Export(IContextInfoDataset<ContextInfo, DomainPerActionTensor> dataset, ExportOptions exportOptions, DiagramBuilderOptions diagramBuilderOptions, ContextInfo classContextInfo, INamingProcessor namingProcessor)
    {
    ...
    private static IEnumerable<UmlNode> GetClassMethods(ContextInfo classContextInfo, IContextInfoDataset<ContextInfo, DomainPerActionTensor> dataset, INamingProcessor namingProcessor, Func<ContextInfo, bool> filter)
    {
