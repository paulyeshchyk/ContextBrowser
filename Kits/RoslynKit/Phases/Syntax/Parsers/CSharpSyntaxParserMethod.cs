    ...
    where TContext : IContextWithReferences<TContext>
{
    ...
    public CSharpSyntaxParserMethod(CSharpMethodContextInfoBuilder<TContext> methodContextInfoBuilder, CSharpSyntaxParserCommentTrivia<TContext> triviaCommentParser, IAppLogger<AppLevel> logger)
    {
        _logger = logger;
