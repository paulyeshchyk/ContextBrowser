...
public class ContextTransitionDiagramBuilder : IContextDiagramBuilder
{
    ...
    public GrouppedSortedTransitionList? Build(string domainName, List<ContextInfo> allContexts, IContextClassifier classifier)
    {
        ...
        var result = FetchAndBuildAllTransitions(domainName, allContexts, classifier);
    ...
    // context: read, transition
    internal GrouppedSortedTransitionList? FetchAndBuildAllTransitions(string domainName, List<ContextInfo> allContexts, IContextClassifier classifier)
    {
    ...
    // context: read, transition
    internal static List<ContextInfo> FetchAllMethods(string domainName, List<ContextInfo> allContexts, IContextClassifier classifier)
    {
        return allContexts
            .Where(ctx =>
    ...
    internal GrouppedSortedTransitionList BuildAllTransitions(string domainName, List<ContextInfo> allContexts, List<ContextInfo> methods)
    {
