...
public class WordTensorBuildStrategyVerbOnly<TTensor> : IWordTensorBuildStrategy<TTensor>
    where TTensor : notnull
{
    ...
    public WordTensorBuildStrategyVerbOnly(ITensorBuilder tensorBuilder, IAppOptionsStore appOptionsStore, ITensorFactory<TTensor> tensorFactory)
    {
