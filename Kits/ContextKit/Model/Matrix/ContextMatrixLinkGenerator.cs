...
public class ContextMatrixLinkGenerator
{
    private readonly IContextClassifier _contextClassifier;
    private readonly List<ContextInfo> _elements;

    public ContextMatrixLinkGenerator(IContextClassifier contextClassifier, List<ContextInfo> elements)
    {
    ...
    public HashSet<(string From, string To)> GenerateMethodLinks()
    {
